...
<div class="wrap">
  ...
  <div class="card">
    ...
    <p class="hint" data-i18n="hint_auto_mode">When enabled: PV ≥ high → SBU, PV ≤ low → UTI. Between thresholds the mode is left unchanged (hysteresis). Min interval is how long PV must stay past the threshold continuously before a switch is written (short spikes are ignored).</p>
    <div class="row">
      ...
      <div><label data-i18n="label_auto_min_interval">Stable hold, s</label><input id="auto_mode_min_interval" type="number" min="60" value="300"></div>
    </div>
...
const I18N = {
  en: {
    ...
    hint_auto_mode: "When enabled: PV ≥ high → SBU, PV ≤ low → UTI. Between thresholds the mode is left unchanged (hysteresis). Min interval is how long PV must stay past the threshold continuously before a switch is written (short spikes are ignored).",
    label_auto_pv_high: "PV high (V) → SBU",
    label_auto_pv_low: "PV low (V) → UTI",
    label_auto_min_interval: "Stable hold, s",
  ...
  ru: {
    ...
    hint_auto_mode: "\u0415\u0441\u043b\u0438 \u0432\u043a\u043b\u044e\u0447\u0435\u043d\u043e: PV \u2265 high \u2192 SBU, PV \u2264 low \u2192 UTI. \u041c\u0435\u0436\u0434\u0443 \u043f\u043e\u0440\u043e\u0433\u0430\u043c\u0438 \u0440\u0435\u0436\u0438\u043c \u043d\u0435 \u043c\u0435\u043d\u044f\u0435\u0442\u0441\u044f (\u0433\u0438\u0441\u0442\u0435\u0440\u0435\u0437\u0438\u0441). \u041c\u0438\u043d. \u0438\u043d\u0442\u0435\u0440\u0432\u0430\u043b \u2014 \u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0441\u0435\u043a\u0443\u043d\u0434 \u043f\u043e\u0434\u0440\u044f\u0434 PV \u0434\u043e\u043b\u0436\u0435\u043d \u0431\u044b\u0442\u044c \u0437\u0430 \u043f\u043e\u0440\u043e\u0433\u043e\u043c, \u043f\u0440\u0435\u0436\u0434\u0435 \u0447\u0435\u043c \u0437\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u0440\u0435\u0436\u0438\u043c (\u043a\u043e\u0440\u043e\u0442\u043a\u0438\u0435 \u0441\u043a\u0430\u0447\u043a\u0438 \u0438\u0433\u043d\u043e\u0440\u0438\u0440\u0443\u044e\u0442\u0441\u044f).",
    label_auto_pv_high: "PV high (V) \u2192 SBU",
    label_auto_pv_low: "PV low (V) \u2192 UTI",
    label_auto_min_interval: "\u0421\u0442\u0430\u0431\u0438\u043b\u044c\u043d\u043e\u0441\u0442\u044c, \u0441",
